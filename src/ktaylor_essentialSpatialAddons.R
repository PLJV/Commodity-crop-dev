...
#
# findMin_raster()
# Find minimum extent from list of raster or extent objects
#
...
#
# quick and dirty.  roll this up with above into a findRaster function.
#
...
clusterProject <- function(x, crs=NULL, n=4){
  require(raster)
  require(rgdal)
  require(snow)
